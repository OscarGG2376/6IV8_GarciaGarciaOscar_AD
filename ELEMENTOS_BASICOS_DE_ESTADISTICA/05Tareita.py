...
plt.hist(df["median_house_value"], bins=30, color='pink', alpha=0.5, label="Valor Medio")
plt.hist(df["total_bedrooms"], bins=30, color='yellow', alpha=0.5, label="Total Dormitorios")
plt.hist(df["population"], bins=30, color='red', alpha=0.5, label="Población")

plt.axvline(df["median_house_value"].mean(), color='red', linestyle='dashed', linewidth=2, label="Promedio Valor Medio")
